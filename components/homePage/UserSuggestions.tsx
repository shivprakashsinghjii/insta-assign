      ...
      <div className="pt-5">
        ...
        >
          {spotlightUsers.map((spotlightUserDetails) => (
            <div
              key={spotlightUserDetails?.userId ?? ''}
              className="flex items-center justify-between py-2"
            >
              <div className="flex items-center gap-2">
                {spotlightUserDetails && spotlightUserDetails.avatarURL && spotlightUserDetails.avatarURL.length !== 0 ? (
                ...
                <div>
                  {spotlightUserDetails && spotlightUserDetails.username && (
                    <Link href={`/${spotlightUserDetails.username}`}>
                      <a>
                        <p className="cursor-pointer text-xs font-semibold">
